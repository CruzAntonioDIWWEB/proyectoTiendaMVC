...
class ProductController
{
    ...
    public function create()
    {
        ...
        //Se obtienen las categorías para el select en el formulario de la vista
    ...
    public function save()
    {
        ...
        if (
            isset($_POST) && !empty($_POST['nombre']) && !empty($_POST['descripcion']) &&
            ...
            if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] === 0) {
                ...
                //Valido datos
                $nombre = trim(filter_var($_POST['nombre'], FILTER_SANITIZE_FULL_SPECIAL_CHARS)); //FLTER_SANITIZE_STRING está en desuso, FULL_SPECIAL_CHARS es más seguro
                ...
                //Validación adicional para la longitud del nombre, precio, stock y categoría
    ...
    public function edit()
    {
        ...
        if (isset($_GET['id'])) {
            ...
            //Obtengo categorías para el select en la vista de edición
            $category = new \Models\Category();
            $categories = $category->getAll();
    ...
    public function update()
    {
        ...
        if (
            ...
            if (isset($_FILES['imagen']) && $_FILES['imagen']['error'] === 0) {
                ...
                //Validación de que se haya subido una imagen tipo jpg, jpeg, png o gif
                if ($mimetype == "image/jpg" || $mimetype == "image/jpeg" || $mimetype == "image/png" || $mimetype == "image/gif") {
                    //Se crea un directorio de imágenes si no existe
                    if (!is_dir('../assets/img')) {
    ...
    public function delete()
    {
        ...
        if (isset($_GET['id'])) {
            ...
            //Obtengo el producto para poder eliminar la imagen asociada
            ...
            if ($productoAEliminar) {
                ...
                if ($delete) {
                    //Si el producto se elimina también se elimina su imagen del servidor
    ...
    public function category()
    {
        if (isset($_GET['id'])) {
            ...
            //Obtención de los productos de la categoría específica
            $product = new \Models\Product();
            $products = $product->getProductsByCategory($categoria_id);

            //Obtención de el nombre de la categoría para mostrarlo en la vista
            ...
            //Si no se proporciona un ID de categoría se redirige al inicio
